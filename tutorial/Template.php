		...
		<div class="media-container-row">
			<div class=" title col-12 col-md-8">
				...
				<!-- Change EXERCISE_TITLE with appropiate key -->
					<?php echo $examples["EXERCISE_TITLE"]; ?></h2>
				<h3 class="mbr-section-subtitle align-center mbr-light mbr-fonts-style display-5">
				<!-- Change EXERCISE_TITLE_DESC with appropiate key -->
					<?php echo $examples["EXERCISE_TITLE_DESC"]; ?></h3>
			</div>
		</div>
	</div>
</section>
...
<section class="cid-qYh0wSah5G" id="image3-50">
    <figure class="mbr-figure container">
			...
			<!-- Change image URL XXX.png with appropriate name -->
                <img id="schematic" src="assets/images/Electronics/XXX.png" width="1400" alt="Multisensor" title=""></img>
            </div>
    </figure>
</section>
...
<section class="cid-qYh0wSah5G" id="image3-50">
    <figure class="mbr-figure container">
            ...
            <div class="image-block mbr-fonts-style display-7" style="width: 50%;">
                <img id="schematic_proto" src="assets/images/Electronics/xx.png" width="1400" alt="Protoboard" title=""></img>
            </div>
    </figure>
</section>
        ...
        <div class="media-container-row">
            <div class="mbr-text counter-container col-12 col-md-8 mbr-fonts-style display-7">
                <ol>
                  ...
                  <li><strong><?php echo $examples["EXERCISE_BASIC_TITLE"]; ?></strong><p><?php echo $examples["EXERCISE_BASIC_DESC"]; ?></i></p><strong><?php echo $website["HINT"]; ?></strong><p><i><?php echo $examples["EXERCISE_BASIC_HINT"]; ?></i></p>
        ...
        <div class="media-container-row">
            <div class="mbr-text counter-container col-12 col-md-8 mbr-fonts-style display-7">
                <ol>
					...
					<li><strong><?php echo $examples["EXERCISE_INTERMEDIATE_TITLE"]; ?></strong><p><?php echo $examples["EXERCISE_INTERMEDIATE_DESC"]; ?></p><strong><?php echo $website["HINT"];?></strong><p><i><?php echo $examples["EXERCISE_INTERMEDIATE_HINT"]; ?></i></p>            
