	...
	Blockly.Arduino.oled_128x32_set_text = function()
		...
		Blockly.Blocks.oled_128x32_draw_circle = {
			...
			subsubcategory: Facilino.locales.getKey('LANG_SUBCATEGORY_GEOMETRY'),
			  ...
			  inputs: [Facilino.locales.getKey('LANG_OLED_FILL'),Facilino.locales.getKey('LANG_OLED_SET_COORDINATE_X'),Facilino.locales.getKey('LANG_OLED_SET_COORDINATE_Y'),Facilino.locales.getKey('LANG_OLED_SET_RADIUS')],
			  init: function() {
