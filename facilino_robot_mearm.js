(function(factory) {
	...
	var load = function(options) {
		...
		Blockly.Arduino.movement_move_arm_setup = function() {
			...
			Blockly.Arduino.definitions_['declare_var_move_mearm_define_robotservo_t'] = 'typedef struct { Servo* servo; uint8_t pin; double offset; double min_pos; double max_pos;} RobotServo_t;\n';
			...
			Blockly.Arduino.definitions_['declare_var_move_mearm_define_robotservos'] = 'RobotServo_t robotServos[JOINTS]={{&_servo'+Blockly.Arduino.valueToCode(this, 'JOINT1', Blockly.Arduino.ORDER_NONE)+','+Blockly.Arduino.valueToCode(this, 'JOINT1', Blockly.Arduino.ORDER_NONE)+','+this.getFieldValue('OJ1')+','+this.getFieldValue('J1MIN')+','+this.getFieldValue('J1MAX')+'},{&_servo'+Blockly.Arduino.valueToCode(this, 'JOINT2', Blockly.Arduino.ORDER_NONE)+','+Blockly.Arduino.valueToCode(this, 'JOINT2', Blockly.Arduino.ORDER_NONE)+','+this.getFieldValue('OJ2')+','+this.getFieldValue('J2MIN')+','+this.getFieldValue('J2MAX')+'},{&_servo'+Blockly.Arduino.valueToCode(this, 'JOINT3', Blockly.Arduino.ORDER_NONE)+','+Blockly.Arduino.valueToCode(this, 'JOINT3', Blockly.Arduino.ORDER_NONE)+','+this.getFieldValue('OJ3')+','+this.getFieldValue('J3MIN')+','+this.getFieldValue('J3MAX')+'}};\n';
			...
			Blockly.Arduino.definitions_['meArm_writeServo']='void writeServo(const RobotServo_t &servo, double angle)\n{\n  angle=constrain(angle+servo.offset,servo.min_pos,servo.max_pos);\n  servo.servo->attach(servo.pin);\n  servo.servo->writeMicroseconds((int)map(angle,0,180,'+this.getFieldValue('SMIN')+','+this.getFieldValue('SMAX')+'));\n}\n';
			Blockly.Arduino.definitions_['meArm_servoDetach']='void detachServo(const RobotServo_t &servo)\n{\n  servo.servo->detach();\n}\n';
