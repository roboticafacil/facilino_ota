	...
	<div class="container">
		<div class="media-container-row">
			<div class=" title col-12 col-md-8">
				...
				<h2 class="align-center pb-3 mbr-fonts-style display-2">
					<?php echo $projects["MOVING_LEDS"]; ?></h2>
				<h3 class="mbr-section-subtitle align-center mbr-light mbr-fonts-style display-5">
					<?php echo $projects["MOVING_LEDS_DESC"]; ?></h3>
			</div>
		</div>
	</div>
</section>
...
<section class="mbr-section article content11 cid-qYh0wTJYr3" id="content11-53">
    <div class="container">
        <div class="media-container-row">
            <div class="mbr-text counter-container col-12 col-md-8 mbr-fonts-style display-7">
                <ol>
			<li><strong><?php echo $projects["EXERCISE_GRADIENT_LEDS"]; ?></strong><p><?php echo $projects["EXERCISE_GRADIENT_LEDS_DESC"]; ?></p><strong><?php echo $website["HINT"]; ?></strong><p><i><?php echo $projects["EXERCISE_GRADIENT_LEDS_HINT"]; ?></i></p>
			...
			<li><strong><?php echo $projects["EXERCISE_GRADIENT_TORNADO_LEDS"]; ?></strong><p><?php echo $projects["EXERCISE_GRADIENT_TORNADO_LEDS_DESC"]; ?></p><strong><?php echo $website["HINT"]; ?></strong><p><i><?php echo $projects["EXERCISE_GRADIENT_TORNADO_LEDS_HINT"]; ?></i></p>
			...
			<li><strong><?php echo $projects["EXERCISE_SET_RANDOM_LED"]; ?></strong><p><?php echo $projects["EXERCISE_SET_RANDOM_LED_DESC"]; ?></i></p><strong><?php echo $website["HINT"]; ?></strong><p><i><?php echo $projects["EXERCISE_SET_RANDOM_LED_HINT"]; ?> </i></p>
			...
			<li><strong><?php echo $projects["EXERCISE_SET_RANDOM_COLOR_LED"]; ?></strong><p><?php echo $projects["EXERCISE_SET_RANDOM_LED_COLOR_DESC"]; ?></i></p><strong><?php echo $website["HINT"]; ?></strong><p><i><?php echo $projects["EXERCISE_SET_RANDOM_LED_COLOR_HINT"]; ?> </i></p>
...
<section class="mbr-section article content11 cid-qYh0wTJYr3" id="content11-53">
    <div class="container">
        <div class="media-container-row">
            <div class="mbr-text counter-container col-12 col-md-8 mbr-fonts-style display-7">
                <ol>
				<li><strong><?php echo $projects["EXERCISE_MOVE_ONE_LED"]; ?></strong><p><?php echo $projects["EXERCISE_MOVE_ONE_LED_DESC"]; ?></i></p><strong><?php echo $website["HINT"]; ?></strong><p><i><?php echo $projects["EXERCISE_MOVE_ONE_HINT"]; ?> </i></p>
			...
			<iframe width="725" height="453" src="https://www.tinkercad.com/embed/ccUjad7O8nr" frameborder="0" marginwidth="0" marginheight="0" scrolling="no"></iframe>
					...
					<li><strong><?php echo $projects["EXERCISE_MOVE_ONE_LED_BLINKING"]; ?></strong><p><?php echo $projects["EXERCISE_MOVE_ONE_LED_BLINKING_DESC"]; ?></i></p><strong><?php echo $website["HINT"]; ?></strong><p><i><?php echo $projects["EXERCISE_MOVE_ONE_LED_BLINKING_HINT"]; ?> </i></p>
			...
			<iframe width="725" height="453" src="https://www.tinkercad.com/embed/gQsFKBB95VD" frameborder="0" marginwidth="0" marginheight="0" scrolling="no"></iframe>
					...
					<li><strong><?php echo $projects["EXERCISE_MOVE_ONE_LED_RANDOM"]; ?></strong><p><?php echo $projects["EXERCISE_MOVE_ONE_LED_RANDOM_DESC"]; ?></p><strong><?php echo $website["HINT"]; ?></strong><p><i><?php echo $projects["EXERCISE_MOVE_ONE_LED_RANDOM_HINT"]; ?></i></p>
			...
			<iframe width="725" height="453" src="https://www.tinkercad.com/embed/fOZb175X2VI" frameborder="0" marginwidth="0" marginheight="0" scrolling="no"></iframe>
					...
					<li><strong><?php echo $projects["EXERCISE_MOVE_ONE_LED_RANDOM_COLOR"]; ?></strong><p><?php echo $projects["EXERCISE_MOVE_ONE_LED_RANDOM_COLOR_DESC"]; ?></p><strong><?php echo $website["HINT"]; ?></strong><p><i><?php echo $projects["EXERCISE_MOVE_ONE_LED_RANDOM_COLOR_HINT"]; ?></i></p>
					<button  type="button" title="Facilino code" onclick="showHideElement('exercise4i');" class="btn-primary display-4"><span class="mbri-extension mbr-iconfont mbr-iconfont-btn"></span></button>
			<div><iframe id="exercise4i" style="display:block" frameBorder="0"  src="" onload="resizeIFrameToFitContent(this);"></iframe></div>
...
<script>
$('#exercise1b').attr('src','../facilino.php?action=view_example&embbeded&id=102&lang='+window.FacilinoLanguage);
$('#exercise2b').attr('src','../facilino.php?action=view_example&embbeded&id=104&lang='+window.FacilinoLanguage);
$('#exercise3b').attr('src','../facilino.php?action=view_example&embbeded&id=106&lang='+window.FacilinoLanguage);
$('#exercise4b').attr('src','../facilino.php?action=view_example&embbeded&id=107&lang='+window.FacilinoLanguage);
$('#exercise1i').attr('src','../facilino.php?action=view_example&embbeded&id=100&lang='+window.FacilinoLanguage);
$('#exercise2i').attr('src','../facilino.php?action=view_example&embbeded&id=101&lang='+window.FacilinoLanguage);
$('#exercise3i').attr('src','../facilino.php?action=view_example&embbeded&id=103&lang='+window.FacilinoLanguage);
$('#exercise4i').attr('src','../facilino.php?action=view_example&embbeded&id=105&lang='+window.FacilinoLanguage);
