	...
	<div class="container">
		<div class="media-container-row">
			<div class=" title col-12 col-md-8">
				...
				<h2 class="align-center pb-3 mbr-fonts-style display-2">
					<?php echo $projects["ECOTHINGS_KITCHEN"]; ?></h2>
				<h3 class="mbr-section-subtitle align-center mbr-light mbr-fonts-style display-5">
					<?php echo $projects["ECOTHINGS_KITCHEN_DESC"]; ?></h3>
			</div>
		</div>
	</div>
</section>
    ...
    <div class="container">
        <div class="media-container-row">
            <div class="mbr-text col-12 col-md-8 mbr-fonts-style display-7">
				...
				<li><?php echo $website["MATERIAL_GAS_SENSOR"]; ?> 39 (A5)</li>
				<li><?php echo $website["MATERIAL_PASSIVE_BUZZER"]; ?> 15 (D5)</li>
				<li><?php echo $website["MATERIAL_FLAME_SENSOR"]; ?> 19 (D12)</li>
				<li><?php echo $website["MATERIAL_SERVO"]; ?> 14 (D7)</li>
				</ul></blockquote>
            </div>
        </div>
    </div>
