(function(factory) {
	...
	Blockly.Arduino.ambient_gas_analog_read = function() {
		...
		Blockly.Blocks.ambient_gas_read_calibrated = {
			...
			category_colour: Facilino.LANG_COLOUR_AMBIENT,
			colour: Facilino.LANG_COLOUR_AMBIENT_GAS,
			keys: ['LANG_GAS_READ_CALIBRATED_NAME','LANG_GAS_READ_CALIBRATED','LANG_GAS_PIN','LANG_GAS_R0','LANG_GAS_SENSOR','LANG_GAS_TYPE','LANG_GAS_H2','LANG_GAS_ALCOHOL','LANG_GAS_LPG','LANG_GAS_CO2','LANG_GAS_CH4','LANG_GAS_CO','LANG_GAS_ALCOHOL','LANG_GAS_SMOKE','LANG_GAS_PROPANE','LANG_GAS_BENZENE','LANG_GAS_NH3','LANG_GAS_READ_CALIBRATED_TOOLTIP'],
