(function(factory) {
	...
	Blockly.Arduino.dyor_move_grip = function() {
		...
		Blockly.Blocks.dyor_move_grip = {
			...
			init: function() {
				...
				this.appendDummyInput('').appendField(Facilino.locales.getKey('LANG_SERVO_MOVE_GRIPPER')).appendField(new Blockly.FieldImage(Facilino.path+'img/blocks/gripper.svg', 20*options.zoom, 20*options.zoom)).setAlign(Blockly.ALIGN_RIGHT);
				this.appendValueInput('LEFT').setAlign(Blockly.ALIGN_RIGHT).appendField(Facilino.locales.getKey('LANG_MOVE_BASE_LEFT')||'Left').appendField(new Blockly.FieldImage(Facilino.path+"img/blocks/servo_signal.svg",20*options.zoom,20*options.zoom)).setCheck(['DigitalPin','PWMPin']).setAlign(Blockly.ALIGN_RIGHT);
				this.appendDummyInput('').appendField(Facilino.locales.getKey('LANG_SERVO_MOVE_ATTACK_DEFEND_FROM')||'From').appendField(new Blockly.FieldImage(Facilino.path+'img/blocks/angle.svg', 20*options.zoom, 20*options.zoom)).appendField(new Blockly.FieldNumber(135,0,180,1),'FROM1').appendField(Facilino.locales.getKey('LANG_SERVO_MOVE_ATTACK_DEFEND_TO')||'to').appendField(new Blockly.FieldImage(Facilino.path+'img/blocks/angle.svg', 20*options.zoom, 20*options.zoom)).appendField(new Blockly.FieldNumber(45,0,180,1),'TO1').setAlign(Blockly.ALIGN_RIGHT);
				this.appendValueInput('RIGHT').setAlign(Blockly.ALIGN_RIGHT).appendField(Facilino.locales.getKey('LANG_MOVE_BASE_RIGHT')||'Right').appendField(new Blockly.FieldImage(Facilino.path+"img/blocks/servo_signal.svg",20*options.zoom,20*options.zoom)).setCheck(['DigitalPin','PWMPin']).setAlign(Blockly.ALIGN_RIGHT);
				this.appendDummyInput('').appendField(Facilino.locales.getKey('LANG_SERVO_MOVE_ATTACK_DEFEND_FROM')||'From').appendField(new Blockly.FieldImage(Facilino.path+'img/blocks/angle.svg', 20*options.zoom, 20*options.zoom)).appendField(new Blockly.FieldNumber(135,0,180,1),'FROM2').appendField(Facilino.locales.getKey('LANG_SERVO_MOVE_ATTACK_DEFEND_TO')||'to').appendField(new Blockly.FieldImage(Facilino.path+'img/blocks/angle.svg', 20*options.zoom, 20*options.zoom)).appendField(new Blockly.FieldNumber(45,0,180,1),'TO2').setAlign(Blockly.ALIGN_RIGHT);
	...
	Blockly.Arduino.dyor_move_arms = function() {
		...
		Blockly.Blocks.dyor_move_arms = {
			...
			init: function() {
				this.setColour(robot_colour);
				this.appendDummyInput('').appendField(Facilino.locales.getKey('LANG_SERVO_MOVE_ARMS')).appendField(new Blockly.FieldImage(Facilino.path+'img/blocks/arms.svg', 52*options.zoom, 25*options.zoom)).setAlign(Blockly.ALIGN_RIGHT);
				this.appendValueInput('LEFT').setAlign(Blockly.ALIGN_RIGHT).appendField(Facilino.locales.getKey('LANG_MOVE_BASE_LEFT')||'Left').appendField(new Blockly.FieldImage(Facilino.path+"img/blocks/servo_signal.svg",20*options.zoom,20*options.zoom)).setCheck(['DigitalPin','PWMPin']).setAlign(Blockly.ALIGN_RIGHT);
				this.appendDummyInput('').appendField(Facilino.locales.getKey('LANG_SERVO_MOVE_ATTACK_DEFEND_FROM')||'From').appendField(new Blockly.FieldImage(Facilino.path+'img/blocks/angle.svg', 20*options.zoom, 20*options.zoom)).appendField(new Blockly.FieldNumber(135,0,180,1),'FROM1').appendField(Facilino.locales.getKey('LANG_SERVO_MOVE_ATTACK_DEFEND_TO')||'to').appendField(new Blockly.FieldImage(Facilino.path+'img/blocks/angle.svg', 20*options.zoom, 20*options.zoom)).appendField(new Blockly.FieldNumber(45,0,180,1),'TO1').setAlign(Blockly.ALIGN_RIGHT);
				this.appendValueInput('RIGHT').setAlign(Blockly.ALIGN_RIGHT).appendField(Facilino.locales.getKey('LANG_MOVE_BASE_RIGHT')||'Right').appendField(new Blockly.FieldImage(Facilino.path+"img/blocks/servo_signal.svg",20*options.zoom,20*options.zoom)).setCheck(['DigitalPin','PWMPin']).setAlign(Blockly.ALIGN_RIGHT);
				this.appendDummyInput('').appendField(Facilino.locales.getKey('LANG_SERVO_MOVE_ATTACK_DEFEND_FROM')||'From').appendField(new Blockly.FieldImage(Facilino.path+'img/blocks/angle.svg', 20*options.zoom, 20*options.zoom)).appendField(new Blockly.FieldNumber(135,0,180,1),'FROM2').appendField(Facilino.locales.getKey('LANG_SERVO_MOVE_ATTACK_DEFEND_TO')||'to').appendField(new Blockly.FieldImage(Facilino.path+'img/blocks/angle.svg', 20*options.zoom, 20*options.zoom)).appendField(new Blockly.FieldNumber(45,0,180,1),'TO2').setAlign(Blockly.ALIGN_RIGHT);
	...
	/*Blockly.Arduino.dyor_set_arms = function() {
		...
		Blockly.Blocks.dyor_attack_defend = {
			...
			init: function() {
				...
				this.appendValueInput('LEFT').setAlign(Blockly.ALIGN_RIGHT).appendField(Facilino.locales.getKey('LANG_SERVO_MOVE_ATTACK_DEFEND_SWORD')||'Sword').appendField(new Blockly.FieldImage(Facilino.path+"img/blocks/servo_signal.svg",20*options.zoom,20*options.zoom)).setCheck(['DigitalPin','PWMPin']).setAlign(Blockly.ALIGN_RIGHT);
				this.appendDummyInput('').appendField(Facilino.locales.getKey('LANG_SERVO_MOVE_ATTACK_DEFEND_FROM')||'From').appendField(new Blockly.FieldImage('img/blocks/angle.svg', 20*options.zoom, 20*options.zoom)).appendField(new Blockly.FieldNumber(90,0,180,1),'FROM1').appendField(Facilino.locales.getKey('LANG_SERVO_MOVE_ATTACK_DEFEND_TO')||'to').appendField(new Blockly.FieldImage(Facilino.path+'img/blocks/angle.svg', 20*options.zoom, 20*options.zoom)).appendField(new Blockly.FieldNumber(45,0,180,1),'TO1').setAlign(Blockly.ALIGN_RIGHT);
				this.appendValueInput('RIGHT').setAlign(Blockly.ALIGN_RIGHT).appendField(Facilino.locales.getKey('LANG_SERVO_MOVE_ATTACK_DEFEND_SHIELD')||'Shield').appendField(new Blockly.FieldImage(Facilino.path+"img/blocks/servo_signal.svg",20*options.zoom,20*options.zoom)).setCheck(['DigitalPin','PWMPin']).setAlign(Blockly.ALIGN_RIGHT);
				this.appendDummyInput('').appendField(Facilino.locales.getKey('LANG_SERVO_MOVE_ATTACK_DEFEND_FROM')||'From').appendField(new Blockly.FieldImage(Facilino.path+'img/blocks/angle.svg', 20*options.zoom, 20*options.zoom)).appendField(new Blockly.FieldNumber(90,0,180,1),'FROM2').appendField(Facilino.locales.getKey('LANG_SERVO_MOVE_ATTACK_DEFEND_TO')||'to').appendField(new Blockly.FieldImage('img/blocks/angle.svg', 20*options.zoom, 20*options.zoom)).appendField(new Blockly.FieldNumber(45,0,180,1),'TO2').setAlign(Blockly.ALIGN_RIGHT);
				this.appendValueInput('TIME').appendField(Facilino.locales.getKey('LANG_SERVO_MOVE_ATTACK_DEFEND_TIME')||'Time [ms]').appendField(new Blockly.FieldImage(Facilino.path+"img/blocks/chronometer.svg",24*options.zoom,24*options.zoom)).setCheck([Number,'Variable']).setAlign(Blockly.ALIGN_RIGHT);
				this.appendDummyInput('ATTACH').appendField(Facilino.locales.getKey('LANG_MOVE_BASE_ATTACH')).appendField(new Blockly.FieldCheckbox('FALSE'),'ATTACH').setAlign(Blockly.ALIGN_RIGHT);
				this.setPreviousStatement(true,'code');
				this.setNextStatement(true,'code');
				this.setInputsInline(false);
